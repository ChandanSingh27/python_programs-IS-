...
def fk_function(plaintext,key1,key2,flag):
    #now convert into ip
    ...
    ip_left,ip_right = divide_bits(ip_value)
    ...
    after_xor = xor(expand_value,key1)
    ...
    print(s0_value_rows_column,s1_value_rows_column)
    ...
    print(s0_table_value,s1_table_value)
...
#     # return string
#     return new
# # print(xor(plaintext,key1))
# print(xor(plaintext,key1))

#print(find_rows_column(['1','1','1','1']))
fk_function(plaintext,key1,key2,0)
